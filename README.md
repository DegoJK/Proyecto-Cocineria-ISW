# Cocineria-ISW-Proyecto-2024
Proyecto semestral del ramo Ingeniería de Software utilizando la plantilla de Didudocl
...
## Descripción General
Cocineria-ISW-Proyecto-2024 es un proyecto semestral llevado a cabo para resolver la problematica de una cocineria ficticia en la cual existen cocineros, meseros, administración de inventario y jefe de cocina
### Backend

El Backend de este proyecto implementa las siguientes funcionalidades principales:
